...
class _EditProductState extends State<EditProduct> {
                  ...
                  Visibility(
                    ...
                    child:Container(
                      ...
                      child:CachedNetworkImage(
                        fit:BoxFit.fill,
                        imageUrl:"http://minemp98.com/fitshoe/image/${widget.product.pid}.jpg",
  ...
  updateProduct() {
    ...
    if (_image!=null){
      ...
      http.post("http://minemp98.com/fitshoe/update_product.php", body: {
      ...
      "weight": weigthEditingController.text,
      ...
      pr.dismiss();
          ...
          http.post("http://minemp98.com/fitshoe/php/update_product.php", body: {
      "prid": widget.product.pid,
      "prname": prnameEditingController.text,
      "quantity": qtyEditingController.text,
      "price": price.toStringAsFixed(2),
