...
import 'package:fit_shoe/mainscreen.dart';
import 'payment.dart';
...
class _CartScreenState extends State<CartScreen> {
 ...
 @override
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar:AppBar(backgroundColor: Colors.purple[200],title: Text('My Cart',style:TextStyle(
                color: Colors.black,)),
                actions:<Widget>[
        IconButton(
      ...
      children:<Widget>[
        Text("Your Cart Content",
        style: TextStyle(color: Colors.purple[900], fontSize: 20,fontWeight: FontWeight.bold),
        ),
      cartData==null
        ?Flexible
        (child:Container(
                                      ...
                                      children: <Widget>[
                                        Container(
                                          ...
                                          child: ClipOval(
                                            ...
                                            imageUrl:
                                                "https://minemp98.com/fitshoe/image/${cartData[index]['id']}.jpg",
  ...
  void _loadCart() {
    ...
    pr.show();
    String urlLoadJobs ="https://minemp98.com/fitshoe/php/load_cart.php";
    http.post(urlLoadJobs, body: {
      "email": widget.user.email,
    }).then((res) {
      print(res.body);
      pr.dismiss();
      if(res.body.contains("Cart Empty")){      
  ...
  _updateCart(int index, String op) {
    ...
    String urlLoadJobs = "https://minemp98.com/fitshoe/php/update_cart.php";
    http.post(urlLoadJobs, body: {
      "email": widget.user.email,
      ...
      builder: (context) => new AlertDialog(
        ...
        actions: <Widget>[
          MaterialButton(
              onPressed: () {
                Navigator.of(context).pop(false);
                http.post("https://minemp98.com/fitshoe/php/delete_cart.php",
                    body: {
                      "email": widget.user.email,
                      "prodid": cartData[index]['id'],
                    }).then((res) {
  ...
  Future<void> _payusingstorecredit(double newamount) async {
    ...
    pr.style(message: "Updating cart...");
    pr.show();
    String urlPayment ="https://minemp98.com/fitshoe/php/paymentsc.php";
