...
class _NewProductState extends State<NewProduct> {
  ...
  File _image;
  var _tapPosition;
  String _scanBarcode = 'click to scan/insert ID';
  String pathAsset = 'assets/images/cam.jpg';
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          ...
          content:
              new Text("Are you sure?", style: TextStyle(color: Colors.brown)),
          actions: <Widget>[
  ...
  insertProduct() {
    ...
    http.post("http://minemp98.com/fitshoe/php/insert_product.php", body: {
      "prid": _scanBarcode,
